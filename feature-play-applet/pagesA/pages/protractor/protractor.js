getApp(),
 Page({
    ...
    move: function(t) {
        var a = this.cxt, i = this.w, e = this.h, s = t.touches[0].y;
        a.clearRect(0, 0, i, e);
    ...
    drawbg: function() {
        var t = this.bgcanvas, a = this.w, i = this.h;
    ...
    drawPointer: function() {
        var t = this.cxt, a = this.w, i = this.n;
    ...
    reset: function() {
        this.bgcanvas.drawImage("../../images/BackGround.png", 0, 0, 400, 1e3, 0, 0, this.width, this.h), 
    ...
    toint: function(t) {
        var a = this.cxt, i = this.w, e = this.h;
    ...
    onLoad: function() {
        ...
        a.windowHeight > 1.6 * a.windowWidth ? this.w = .8 * a.windowWidth : this.w = a.windowHeight / 2, 
        this.h = a.windowHeight, this.width = a.windowWidth, this.cxt = wx.createCanvasContext("secCanvas"), 
        this.bgcanvas = wx.createCanvasContext("firstCanvas"), this.bgcanvas.drawImage("../../images/BackGround.png", 0, 0, 400, 1e3, 0, 0, this.width, this.h), 
        this.cxt.translate(.04 * this.w, this.h / 2), this.drawbg(), this.drawPointer();
    },
    onShareAppMessage: function(e) {
      return  {
          title: "尺子量一量到底有多长？",
          path: "/pagesA/pages/rule/index"
